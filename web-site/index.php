...
<div id="container"> 
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <!--<li class="drop"><a href="services.html">Our Services</a>
              <ul class="dropdown">
                ...
                <li><a href="insurance.html">Insurance Planning</a></li>
                <li><a href="tax.html">Tax Planning</a></li>
  ...
  <section id="home-section" class="slider1"> 
        ...
        <ul>
          ...
          <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide"> 
            ...
            <div class="tp-caption finewide_medium_white lfl tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 8; max-width: auto; max-height: auto; white-space: nowrap;"><img src="upload/slide/slide2-img.png" alt=""> </div>
          </li>
          
          <!-- SLIDE  -->
          
          <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Ken Burns Slide"> 
            ...
            <div class="tp-caption small_text customin tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;">We are experience company </div>
            ...
            <div class="tp-caption finewide_medium_white lfl tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;">finance SERVICES </div>
            ...
            <div class="tp-caption finewide_medium_white lfr tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;"><span>Creative &amp; Professional </span> </div>
            ...
            <div class="tp-caption lfb tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 12; max-width: auto; max-height: auto; white-space: nowrap;"><a href='#' class='trans-btn'>View Projects</a> </div>
          </li>
    ...
    <div class="float_right address request-quote">
      <div class="top-info">
  ...
  <section class="grow-business">
    <div class="container">
      <div class="row">
        <div class="right-img"><img src="images/grow-business.png" alt=""></div>
        <div class="col-md-4">
          <div class="project-title title title2">
            <h2 class="box-header">We are help you to grow your business</h2>
          </div>
        </div>
        <div class="counter-up counter-up-style-1 text-center col-md-8">
          <ul>
            <li>
              <p><span class="couterup" id="yoe" data-from="1" data-to="10" data-speed="5000" data-refresh-interval="50">10</span></p>
              <span class="label-counter">Years of experience</span> </li>
            <li>
              <p><span class="couterup" data-from="20" data-to="95" data-speed="5000" data-refresh-interval="50">95</span><span class="unit">K</span></p>
              <span class="label-counter">Happy Customers</span> </li>
            <li>
              <p><span class="couterup" data-from="10" data-to="100" data-speed="5000" data-refresh-interval="50" id="satis">100</span><span class="unit">%</span></p>
              <span class="label-counter">Satisfaction</span> </li>
          </ul>
        </div>
        <!-- End counter up --> 
  ...
  <section class="about-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 who-img pad60">
          <div class="call-back-form">
            <form action="GET" method="POST">
              <p>How can we help? *</p>
              <div class="fancy-select">
                <select class="form-control custom-form custom-select fancified">
              ...
              <div class="row">
                <div class="form-group col-md-6 custom-form">
                  <input class="form-control" id="names" placeholder="Your Name: *" type="text">
                </div>
                <div class="form-group col-md-6 custom-form">
                  <input class="form-control" id="phone" placeholder="Phone Number: *" type="text">
                </div>
              </div>
              <button type="submit" class="button-one btn btn-submit">Submit</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <section class="choose-section">
    <div class="container">
      <div class="project-title title"> <span class="sm-title">Our awesome features</span>
      ...
      <div class="choose-box">
        <div class="row"> 
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 text-right">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 feature">
                <div class="feature-icon right"> <span class="icon icon-Time"></span> </div>
                <h4 class="text-uppercase">24/7 Supports</h4>
                <p>all financeion sites open for visitors, with 24/7 video surveillance being conducted at all objects</p>
              </div>
              
              <!-- .col-md-12 end -->
              
              <div class="col-xs-12 col-sm-12 col-md-12 feature">
                <div class="feature-icon right"> <span class="icon icon-Dollars"></span> </div>
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 hidden-xs hidden-sm text-center">
            <div class="feature-img"> <img src="images/choose.jpg" alt="image"> </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 feature">
                <div class="feature-icon"> <span class="icon icon-Users"></span> </div>
                <h4 class="text-uppercase">Our Dedicated Team</h4>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 feature">
                <div class="feature-icon"> <span class="icon icon-Megaphone"></span> </div>
      ...
      <div class="col-md-6">
        <div class="tab-posts-box">
          <ul class="nav nav-tabs" id="myTab">
            <li class="active"> <a href="#option1" data-toggle="tab">Fast Approval</a> </li>
            <li> <a href="#option2" data-toggle="tab">Refinancing</a> </li>
            <li> <a href="#option3" data-toggle="tab">Documentation</a> </li>
          </ul>
        ...
        <div class="row">
            ...
            <article>
              <div class="news-post">
                <div class="img-cap-effect">
                  <div class="img-box"> <img src="upload/others/ser1.jpg" alt="Awesome Image">
                ...
                <div class="post-content-text">
                  <ul class="blog_infos nav">
                    <li class="date"><a href="#">19 <small> May </small></a></li>
                  </ul>
          ...
          <div class="col-md-4 col-sm-6">
            <article>
              <div class="news-post">
                <div class="img-cap-effect">
                  <div class="img-box"> <img src="upload/others/ser2.jpg" alt="Awesome Image">
                    <div class="img-caption">
                      <div class="box-holder"></div>
                    </div>
                  </div>
          ...
          <div class="col-md-4 col-sm-6">
            <article>
              <div class="news-post">
                <div class="img-cap-effect">
                  <div class="img-box"> <img src="upload/others/ser3.jpg" alt="Awesome Image">
                    <div class="img-caption">
                      <div class="box-holder"></div>
                    </div>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="footer-widget">
              <h2>Our Services</h2>
              <ul class="link-list">
                <li><a href="#">Financial Planning Fans</a></li>
                <li><a href="#">Investment Management</a></li>
                <li><a href="#">Taxes Planning</a></li>
                <li><a href="#">Business Loan</a></li>
                <li><a href="#">Insurance Consulting</a></li>
                <li><a href="#">Retirement Management</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
...
<div id="myModal" class="modal fade services-offer-section" role="dialog">
        ...
        <div class="forms">
          <div class="">
            <div class="cta-form">
              ...
              <div class="form">
                <form novalidate id="quote-form" action="assets/php/sendquote.php" method="post">
                  <input aria-required="true" class="form-control" name="quote-name" id="name" placeholder="Your Name" required type="text">
                  <input aria-required="true" class="form-control" name="quote-email" id="email" placeholder="Email" required type="email">
                  <input aria-required="true" class="form-control" name="quote-telephone" id="telephone" placeholder="Telephone" required type="text">
                  <textarea aria-required="true" class="form-control" name="quote-message" id="quote" placeholder="Quote Details" rows="2" required></textarea>
